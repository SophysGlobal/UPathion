...
const UserProfile = () => {
  ...
  const roleLabel = getRoleLabel(profile?.school_type ?? undefined);
        ...
        <div className="gradient-border animate-fade-in">
          <div className="bg-card/90 backdrop-blur-sm rounded-lg p-6 text-center">
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getRoleBadgeColor(profile.school_type ?? undefined)}`}>
                {roleLabel}
              </span>
            </div>
          </div>
